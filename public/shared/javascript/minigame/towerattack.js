...
var CScenePreload = function()
{
	...
	if( typeof CUI === 'undefined' )
	{
		this.m_rgScriptsToLoad = [
			'http://steamcommunity-a.akamaihd.net/public/javascript/minigame/towerattack/running.js?v=' + g_JSCacheKey + '&l=english',
			'http://steamcommunity-a.akamaihd.net/public/javascript/minigame/towerattack/network.js?v=' + g_JSCacheKey + '&l=english',
			'http://steamcommunity-a.akamaihd.net/public/javascript/minigame/towerattack/ui.js?v=' + g_JSCacheKey + '&l=english',
			'http://steamcommunity-a.akamaihd.net/public/javascript/minigame/towerattack/easing.js?v=' + g_JSCacheKey + '&l=english',
			'http://steamcommunity-a.akamaihd.net/public/javascript/minigame/towerattack/enemies.js?v=' + g_JSCacheKey + '&l=english'
		];
	} else {
		this.m_rgScriptsToLoad = [];
	}
