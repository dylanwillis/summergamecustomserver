...
CServerInterface.prototype.Connect = function( callback )
{
	...
	var rgResult = {"webapi_host":"http:\/\/localhost\/","webapi_host_secure":"http:\/\/localhost\/","token":"28d39e6467b5c35a50c8491a57b9aecf","steamid":"76561197999425747","persona_name":"Reasonably Priced Corgi","success":1}
...
CServerInterface.prototype.UseAbilities = function( callback, failed, rgParams )
{
	...
	$J.ajax({
		url: this.m_WebAPI.BuildURL( 'ITowerAttackMiniGameService', 'UseAbilities', false ),
		method: 'POST',
		data: rgRequest,
		xhrFields : {
			responseType : 'arraybuffer'
...
CServerInterface.prototype.ChooseUpgrades = function( callback, upgrades )
{
	...
	$J.ajax({
		url: this.m_WebAPI.BuildURL( 'ITowerAttackMiniGameService', 'ChooseUpgrade', false ),
		method: 'POST',
		data: rgRequest,
		xhrFields : {
			responseType : 'arraybuffer'
...
CServerInterface.prototype.UseBadgePoints = function( callback, abilityItems )
{
	...
	$J.ajax({
		url: this.m_WebAPI.BuildURL( 'ITowerAttackMiniGameService', 'UseBadgePoints', false ),
		method: 'POST',
		data: rgRequest,
		xhrFields : {
			responseType : 'arraybuffer'
